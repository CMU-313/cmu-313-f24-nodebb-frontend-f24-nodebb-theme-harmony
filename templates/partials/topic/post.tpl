...
<div class="d-flex align-items-start gap-3">
	<div class="bg-body d-none d-sm-block rounded-circle" style="outline: 2px solid var(--bs-body-bg);">
		{{{ if posts.anon }}}
			<span class="d-inline-block position-relative text-decoration-none" aria-label="Anonymous User">
				<i class="fa fa-user-secret fa-3x text-muted"></i> <!-- Icon for anonymous user -->
		{{{ else }}}
	...
	<div class="post-container d-flex flex-grow-1 flex-column w-100" style="min-width:0;">
		<div class="d-flex align-items-center gap-1 flex-wrap w-100 post-header mt-1" itemprop="author" itemscope itemtype="https://schema.org/Person">
			...
			{{{ else }}} <!-- Real username and profile URL -->
			...
			{{{ if (posts.user.banned && !posts.anon) }}}
			...
			{{{ if (posts.user.custom_profile_info.length && !posts.anon) }}}
			<div>
				<span>
					&#124;
